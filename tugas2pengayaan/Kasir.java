...
public class Kasir {
    ...
    public void tampilkanDaftarMeja() {
        System.out.println("Meja yang tersedia : ");
        for (int i = 1; i <= this.daftarMeja.length; i++) {
            System.out.println("Meja " + (i) + (daftarMeja[i - 1].isKosong() ? " (kosong)" : " (terisi oleh pelanggan " + daftarMeja[i - 1].getPelanggan().getNama() + ")"));
        }
    }
        ...
        while (pilihan != 0) {
            ...
            switch (pilihan) {
                ...
                case 2:
                    ...
                    scanner.nextLine();
                    // menandai meja dengan nama pelanggan
                    System.out.print("Masukkan nama pelanggan: ");
                    tambahPelanggan(nomorMeja, new Pelanggan(scanner.nextLine()));
                    break;
                case 3:
                ...
                case 4:
                    ...
                    if (daftarMeja[nomorMeja - 1].isKosong()) {
                        ...
                        System.out.println("Meja di nomor " + nomorMeja + " telah dihapuskan" );
                    }
                break;
                case 5:
                    ...
                    if (daftarMeja[nomorMeja - 1].getMenu()[0] == null) {
                        System.out.println("Meja " + nomorMeja + " belum memesan");
                    } else {
                        System.out.println("Total harga di meja " + nomorMeja + " adalah " + hitungHargaPesanan(nomorMeja));
